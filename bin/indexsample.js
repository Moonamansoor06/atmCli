...
const withdrawalInserter = (digit) => {
...
const displayTimedMessage = (message, default_message) => {
    if (!messageTimerOn) {
        messageTimerOn = true;
...
function withdraw(amount_to_withdraw) {
    let trueBalance = balance + overdraftLimit;
